...
Run everything:
Expected output ends with `TOTAL: 414 passed, 0 failed across 22 files`.
...
**Automated below (390 tests, run on every commit, all synthetic data):**
the 20 files in this directory.
...
None of the 390 tests below have touched real GPU hardware. They test logic
