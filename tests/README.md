...
Run everything:
Expected output ends with `TOTAL: 670 passed, 0 failed across 32 files`.
...
**Automated below (646 tests, run on every commit, all synthetic data):**
the 30 files in this directory.
...
None of the 646 tests below have touched real GPU hardware. They test logic
