...
Run everything:
Expected output ends with `TOTAL: 381 passed, 0 failed across 20 files`.
...
**Automated below (357 tests, run on every commit, all synthetic data):**
the 18 files in this directory.
...
None of the 357 tests below have touched real GPU hardware. They test logic
