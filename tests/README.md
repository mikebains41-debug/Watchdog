...
Run everything:
Expected output ends with `TOTAL: 170 passed, 0 failed across 11 files`.
...
**Automated below (146 tests, run on every commit, all synthetic data):**
the 9 files in this directory.
...
None of the 146 tests below have touched real GPU hardware. They test logic
