...
Run everything:
Expected output ends with `TOTAL: 460 passed, 0 failed across 24 files`.
...
**Automated below (436 tests, run on every commit, all synthetic data):**
the 22 files in this directory.
...
None of the 436 tests below have touched real GPU hardware. They test logic
