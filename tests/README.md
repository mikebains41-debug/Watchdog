...
Run everything:
Expected output ends with `TOTAL: 281 passed, 0 failed across 15 files`.
...
**Automated below (257 tests, run on every commit, all synthetic data):**
the 13 files in this directory.
...
None of the 257 tests below have touched real GPU hardware. They test logic
