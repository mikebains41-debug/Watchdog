...
**Automated below (105 tests, run on every commit, all synthetic data):**
the 7 files in this directory.
...
None of the 105 tests below have touched real GPU hardware. They test logic
