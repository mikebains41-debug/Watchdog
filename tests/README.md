...
**Automated below (52 tests, run on every commit, all synthetic data):**
the 5 files in this directory.
...
None of the 52 tests below have touched real GPU hardware. They test logic
