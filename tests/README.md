...
Run everything:
Expected output ends with `TOTAL: 330 passed, 0 failed across 17 files`.
...
**Automated below (306 tests, run on every commit, all synthetic data):**
the 15 files in this directory.
...
None of the 306 tests below have touched real GPU hardware. They test logic
