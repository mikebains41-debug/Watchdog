...
Run everything:
Expected output ends with `TOTAL: 398 passed, 0 failed across 21 files`.
...
**Automated below (374 tests, run on every commit, all synthetic data):**
the 19 files in this directory.
...
None of the 374 tests below have touched real GPU hardware. They test logic
