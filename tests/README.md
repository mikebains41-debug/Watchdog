...
Run everything:
Expected output ends with `TOTAL: 434 passed, 0 failed across 23 files`.
...
**Automated below (410 tests, run on every commit, all synthetic data):**
the 21 files in this directory.
...
None of the 410 tests below have touched real GPU hardware. They test logic
