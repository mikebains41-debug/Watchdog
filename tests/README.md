...
Run everything:
Expected output ends with `TOTAL: 506 passed, 0 failed across 26 files`.
...
**Automated below (482 tests, run on every commit, all synthetic data):**
the 24 files in this directory.
...
None of the 482 tests below have touched real GPU hardware. They test logic
