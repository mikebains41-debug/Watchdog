...
Run everything:
Expected output ends with `TOTAL: 254 passed, 0 failed across 14 files`.
...
**Automated below (230 tests, run on every commit, all synthetic data):**
the 12 files in this directory.
...
None of the 230 tests below have touched real GPU hardware. They test logic
