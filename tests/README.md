...
Run everything:
Expected output ends with `TOTAL: 637 passed, 0 failed across 31 files`.
...
**Automated below (613 tests, run on every commit, all synthetic data):**
the 29 files in this directory.
...
None of the 613 tests below have touched real GPU hardware. They test logic
