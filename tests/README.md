...
Run everything:
Expected output ends with `TOTAL: 485 passed, 0 failed across 25 files`.
...
**Automated below (461 tests, run on every commit, all synthetic data):**
the 23 files in this directory.
...
None of the 461 tests below have touched real GPU hardware. They test logic
