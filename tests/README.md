...
Run everything:
Expected output ends with `TOTAL: 303 passed, 0 failed across 16 files`.
...
**Automated below (279 tests, run on every commit, all synthetic data):**
the 14 files in this directory.
...
None of the 279 tests below have touched real GPU hardware. They test logic
