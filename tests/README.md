...
Run everything:
Expected output ends with `TOTAL: 536 passed, 0 failed across 27 files`.
...
**Automated below (512 tests, run on every commit, all synthetic data):**
the 25 files in this directory.
...
None of the 512 tests below have touched real GPU hardware. They test logic
